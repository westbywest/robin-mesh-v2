...
<html>
<head>
<title>Interfaces: Robin-Mesh</title>
...
<tr><td colspan=2><div class=textarea>IPv4 interfaces</div></td></tr>
<tr><td colspan=2><pre>
EOF_02
ifconfig
cat <<EOF_03
</pre></td></tr>
<tr><td colspan=2><div class=textarea>802.11 (wireless) interfaces</div></td></tr>
<tr><td colspan=2><pre>
EOF_03
iwconfig
cat <<EOF_99
